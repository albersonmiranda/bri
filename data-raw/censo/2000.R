...
# dados do IBGE
censo_2000 = foreign::read.dbf("data-raw/censo/RENDABR00.dbf")
...
censo_2000 = censo_2000 %>% inner_join(mapa, by = c("MUNCOD" = "code_muni")) %>%
...
usethis::use_data(censo_2000, overwrite = TRUE)

#' Dados de Censo de 2000 do IBGE
#'
#' Um dataset contendo dados do censo de 2000 do IBGE com informacoes de raca.
...
#'
#' @format A tibble with 5507 rows and 51 variables:
#' \describe{
